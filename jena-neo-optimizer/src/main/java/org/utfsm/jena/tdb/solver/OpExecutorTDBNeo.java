...
package org.utfsm.jena.tdb.solver;
...
import org.utfsm.apache.cmds.tdb.tdbqueryplan;
 ...
 */
public class OpExecutorTDBNeo extends OpExecutor
{
    private static final Logger log = LoggerFactory.getLogger(OpExecutorTDBNeo.class) ;

    public final static OpExecutorFactory OpExecFactoryTDB = OpExecutorTDBNeo::new;
    ...
    public OpExecutorTDBNeo(ExecutionContext execCxt)
    {
        super(execCxt) ;
    ...
    private static class OpExecutorPlainTDB extends OpExecutor
    {
        ...
        public QueryIterator execute(OpBGP opBGP, QueryIterator input)
        {
            ...
            if ( g instanceof GraphTDB )
            {
                ...
                //End of plan optimization extraction
...
//                    Log.info("EXECUTION_TREE", tree.toString());
        ...
        /**
         * Extract the tipe of triple ej [VAR, URI, VAR], [VAR, URI, URI] etc.
         * @param node
         * @return
         */
